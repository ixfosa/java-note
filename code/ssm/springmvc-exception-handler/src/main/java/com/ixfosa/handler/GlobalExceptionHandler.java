...
/**
 * Created by ixfosa on 2021/4/25 14:41
 */
...
public class GlobalExceptionHandler {
    ...
    public ModelAndView doNameException(Exception ex) {
        ...
        mv.addObject("msg","姓名必须是 ixfosa，其它用户不能访问");
        mv.addObject("ex",ex);
        mv.setViewName("nameErr");
        return mv;
    }
    ...
    public ModelAndView doOtherException(Exception ex){
        //处理其它异常
        ModelAndView mv = new ModelAndView();
        mv.addObject("msg","other exception...");
        mv.addObject("ex",ex);
        mv.setViewName("defaultErr");
        return mv;
    }
}
